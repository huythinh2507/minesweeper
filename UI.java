...
public class UI extends JFrame
{
    ...
    //---------------------------------------------------------------//
    public UI(int r, int c, int m) throws IOException {
        this.rows = r;
        this.cols = c;
        ...
        timePassedLabel.setBackground(new Color(254, 0, 51, 250));
        ...
        minesLabel.setBackground(new Color(254, 0, 51, 250));
        ...
        statistics = new JMenuItem("   Details");
        exit = new JMenuItem("   Quit");

        newGame.setName("New Game");
        statistics.setName("Details");
        exit.setName("Quit");
        ...
        p.setBorder(BorderFactory.createEmptyBorder(20, 60, 14, 60));
        p.setOpaque(false);


        setLayout(new BorderLayout());
        JLabel background = new JLabel(new ImageIcon(getClass().getResource("/resources/images/2.3.png")));
